...
Class Action {
    ...
    $data .= ", date_in = '$date_in $date_in_time' "; // Combine date and time
    $out = date("Y-m-d H:i", strtotime("$date_in $date_in_time + $days days")); // Calculate checkout date and time
    $data .= ", date_out = '$out' ";
    ...
    $save = $this->db->query("INSERT INTO checked SET $data"); // Use SET for INSERT query
